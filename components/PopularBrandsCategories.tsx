...
interface PopularBrandsCategoriesProps {
  categories: string[]
  title?: string
  limit?: number
...
export function PopularBrandsCategories({
  categories,
  title = "Popüler Araba Parçaları",
  limit = 18, // Default to 18 if not specified
  onCategoryClick,
  onShowAll,
}: PopularBrandsCategoriesProps) {
  // Use the limit prop to determine how many categories to show
